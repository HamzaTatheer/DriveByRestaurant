    ...
    return (
        ...
        <div>
           <div style={{minHeight:"130px",paddingLeft:"50px",paddingRight:"50px",background:"black",color:"white"}} className="row no-gutters d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center"> <Avatar><img src={`http://localhost:3004/public/uploads/profile_pictures/${user.pfp}`}/></Avatar> <span style={{display:"inline",paddingLeft:"10px"}}>Welcome {user.name}</span></div>
